...
declare -a BLOCK_FILES=(
  ...
  "stage8_aaai/block3_perturbation_comparison.py"
  "stage8_aaai/block4_non_oracle.py"
)
...
echo "============================================================"
echo "Per-block JSON: stage8_aaai/results/block{1..4}_results.json"
echo "Per-block PDF : stage8_aaai/results/block{1..4}_*.pdf"
