...
printf '\nArtifacts:\n'
printf '  stage1_unified/results.json\n'
printf '  stage2_paper/results_part_a.json\n'
printf '  stage2_paper/results_part_b.json\n'
printf '  stage2_paper/figures/fig1_gap_vs_dw.pdf\n'
printf '  stage2_paper/figures/fig2_collapse.pdf\n'
printf '  stage2_paper/figures/fig3_lambda_phase.pdf\n'
printf '  stage2_paper/figures/fig4_resource_graph.pdf\n'
printf '  stage2_paper/figures/table1_properties_scaling.csv\n'
printf '  stage2_paper/benchmark/benchmark_returns.pdf\n'
printf '  stage2_paper/benchmark/benchmark_h_sweep.pdf\n'
printf '  stage2_paper/benchmark/benchmark_results.csv\n'
