#!/usr/bin/env bash
# experiments/stage9_embodied_family/run_stage9.sh
# ================================================
#
...
mkdir -p experiments/stage9_embodied_family/results
...
for env in env1_doorkey_lava env2_sokoban_barrier env3_resource_depletion; do
  ...
  python "experiments/stage9_embodied_family/${env}.py"
done
...
echo "############################################################"
python experiments/stage9_embodied_family/run_stage9.py
ec=$?
